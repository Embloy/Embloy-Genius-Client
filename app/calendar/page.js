...
export default function Calendar() {
  ...
  const [events, setShowEvents] = useState([
    ...
    },
    {
      title: "event 2",
      id: "2",
      start: "2023-08-30 06:16:28",
      end: "2023-08-30 16:00:00",
    },
    {
      title: "event 3",
      id: "3",
      start: "2023-08-31 06:16:28",
      end: "2023-08-31 16:00:00",
    },
    {
      title: "event 4",
      id: "4",
      start: "2023-09-01 06:16:28",
      end: "2023-09-01 16:00:00",
    },
    {
      title: "event 5",
      id: "5",
      start: "2023-09-02 06:16:28",
      end: "2023-09-02 16:00:00",
    },
  ]);
  ...
  function handleDateClick(arg) {
    ...
    const currentMonth2 = String(
      twoHoursAfterClickDate.getMonth() + 1
    ).padStart(2, "0");
    const currentDay2 = String(twoHoursAfterClickDate.getDate()).padStart(
      2,
      "0"
    );
    const currentHour2 = String(twoHoursAfterClickDate.getHours()).padStart(
      2,
      "0"
    );
    const currentMinute2 = String(twoHoursAfterClickDate.getMinutes()).padStart(
      2,
      "0"
    );
  ...
  const { data, error } = useSWR(
    `${siteConfig.api_url}/assignment/?user_id=77`,
    fetcher
  );
