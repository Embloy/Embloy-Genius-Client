        ...
        <div className="w-full flex flex-col sm:flex-row items-start justify-start my-6 gap-6">
          <div className="w-full sm:w-2/3 py-4 px-8 flex flex-col items-start justify-between gap-2 bg-embloy-purple text-white rounded-lg border-[1px] border-transparent transition duration-200 ease-in-out hover:border-white overflow-auto h-[750px]">
            ...
            <div className="flex flex-col justify-start gap-0.5 w-full">
              ...
              <h1 className="font-medium text-sm text-embloy-purple-lighter">
                Note:
              </h1>
              <p>
                You need to be subscribed at least to&nbsp;
                <a
            ...
            <div className="flex flex-row gap-5 text-md">
              <p>
                ...
                <a
                  className="font-medium hover:text-embloy-purple-lighter"
                  href="https://developers.embloy.com/docs/core/jobs/create_jobs"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                navigator.clipboard
                  .writeText(`<button onClick={handleApplyClick}>
                ...
                {!topJSXIsHovered && (
                  <>
                    <div className="flex flex-row items-center justify-start gap-2">
                      ...
                      />
                      <p className="font-semibold text-sm text-embloy-purple-lighter">
                        CLIENT-SIDE
                      </p>
  ...
  <img src="https://embloy.com/images/button-black_large.svg" style={{ width: "300px", height: "auto" }} />
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                navigator.clipboard
                  .writeText(`func yourExampleEndpoint(c *gin.Context) {
...
c.Redirect(http.StatusFound, redirectURL)`);
            ...
            >
              ...
              {topGoIsHovered && (
                <>
                  <div
                    className="w-full flex flex-row items-left justify-start g-2"
...
c.Redirect(http.StatusFound, redirectURL)`}
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                navigator.clipboard
                  .writeText(`const session = new EmbloySession({
  mode: "job",
  job_slug: "your-job-slug",
  success_url: "your-success-url",
  cancel_url: "your-cancel-url",
  ...
  .catch(error => console.error(error.message));`}
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                navigator.clipboard
                  .writeText(`# Replace 'YOUR_CLIENT_TOKEN' with your actual client token
      session = {
          mode: "job",
...
redirect_url = embloy_client.make_reques`}
            ...
            <div className="w-full flex flex-row items-center justify-between">
              <a
                ...
                href="https://developers.embloy.com/docs/sdks/overview"
                target="_blank"
                rel="noopener noreferrer"
              >
                GO TO DOCUMENTATION
          ...
          <div className="md:w-1/3">
            <div className=" py-4 items-start justify-start px-8 flex flex-col gap-2 bg-embloy-purple text-white rounded-lg border-[1px] border-transparent transition duration-200 ease-in-out hover:border-white overflow-auto h-[450px]">
              <div className="w-full flex flex-row items-start justify-between">
                ...
                <div className="py-2 flex flex-row items-center justify-between gap-2">
                  <p className="font-normal text-sm text-embloy-purple-light">
                    {currentNewsIndex + 1}
                  </p>
                  <p className="font-normal text-sm text-embloy-purple-light">
                    {" "}
                ...
                <div className="py-2 flex flex-row items-center justify-between gap-2">
                  <button
                    className="p-1 font-medium text-sm text-embloy-purple-light hover:text-embloy-purple-lighter rounded-full"
              ...
              <div className="flex flex-col gap-0.5 w-full">
                ...
                <div className="h-1" />
                <div className="h-[1px] w-full rounded-full bg-embloy-purple-lighter" />
                <p className="font-medium text-sm text-embloy-purple-lighter">
                  {currentNews.title}
                </p>
                <div className="h-1" />
            ...
            <div className="my-5 py-4 px-8 flex flex-col gap-2 bg-embloy-purple text-white rounded-lg border-[1px] border-transparent transition duration-200 ease-in-out hover:border-white overflow-auto h-[280px]">
              ...
              <div className="w-full flex flex-col gap-2">
                ...
                >
                  <img
                    src="/icons/integrations-light.svg"
                    alt="job icon"
                    style={{ width: "20px", height: "20px" }}
                  />
                  Your jobs
                ...
                >
                  <img
                    src="/icons/sm-plugged-in-light.svg"
                    alt="api icon"
                    style={{ width: "20px", height: "20px" }}
                  />
