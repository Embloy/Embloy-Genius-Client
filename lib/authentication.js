...
export const request_refresh = (email, password) => {
    return new Promise((resolve, reject) => {
        //fetch("http://192.168.56.1:3000/api/v0/auth/token/refresh", {
        fetch("http://192.168.178.126:3000/api/v0/auth/token/refresh", {
        //fetch("http://192.168.10.60:3000/api/v0/auth/token/refresh", {
            method: 'POST',
            headers: new Headers({
...
export const request_access = (refresh_token) => {
    return new Promise((resolve, reject) => {
        //fetch("http://192.168.56.1:3000/api/v0/auth/token/access", {
        fetch("http://192.168.178.126:3000/api/v0/auth/token/access", {
        //fetch("http://192.168.10.60:3000/api/v0/auth/token/access", {
            method: 'POST',
            headers: new Headers({
                'Content-Type': 'application/json',
...
export const request_client = (access_token) => {
    return new Promise((resolve, reject) => {
        //fetch("http://192.168.56.1:3000/api/v0/auth/token/client", {
        fetch("http://192.168.178.126:3000/api/v0/auth/token/client", {
        //fetch("http://192.168.10.60:3000/api/v0/auth/token/client", {
            method: 'POST',
            headers: new Headers({
                'Content-Type': 'application/json',
...
export const update_password = (access_token, password, password_confirmation) => {
    ...
    return new Promise((resolve, reject) => {
        //fetch("http://192.168.56.1:3000/api/v0/user/password", {
