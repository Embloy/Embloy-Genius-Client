...
export const upload_profile_image = (file,router,recursive) => {
    return new Promise((resolve, reject) => {
        ...
        fetch("https://api.embloy.com/api/v0/user/image", {
            method: 'POST',
            headers: new Headers({
...
export const post_core = (path, router, body, recursive) => {
    return new Promise((resolve, reject) => {
        fetch("https://api.embloy.com/api/v0/"+path, {
            method: 'POST',
            headers: new Headers({
                'access_token': getCookie("access", {path: "/"}),
...
export const get_genius_query = (path) => {
    try {
        let url = "https://api.embloy.com/api/v0/" + path;
        return new Promise((resolve, reject) => {
...
export const get_ops = (path, router, recursive = false) => {
    try {
        ...
        let url = "http://localhost:8080/api/v0/" + path;
        return new Promise((resolve, reject) => {
            fetch(url, {
                method: 'GET',
                headers: new Headers({
